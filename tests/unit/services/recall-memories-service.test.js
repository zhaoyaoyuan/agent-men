...
describe('createRecallMemoriesService', () => {
    ...
    it('should limit results after sorting by score', async () => {
        const memoryRepository = {
            async findByProjectId() {
                return [
                    { id: 'm1', projectId: 'p1', memoryType: 'fact', title: 'A', content: 'about x' },
                    { id: 'm2', projectId: 'p1', memoryType: 'fact', title: 'B', content: 'about y' },
                    { id: 'm3', projectId: 'p1', memoryType: 'fact', title: 'C', content: 'about x y' },
                    { id: 'm4', projectId: 'p1', memoryType: 'fact', title: 'D', content: 'x is great' },
                ];
            },
        };
        const service = createRecallMemoriesService({
