...
import type { EventRecord, EventRecordInput, EventRecordLike } from './event-repository'
...
export class SQLiteEventRepository {
  ...
  async insert(record: EventRecordInput): Promise<void> {
    ...
    `).run(
      ...
      fullRecord.user_id,
      fullRecord.agent_id,
      fullRecord.event_type,
      fullRecord.source_type,
      fullRecord.scope_type,
      fullRecord.scope_key,
      fullRecord.title,
      fullRecord.summary,
      fullRecord.content_text,
      fullRecord.payload_json,
      fullRecord.content_storage_mode,
      fullRecord.importance_score,
      fullRecord.happened_at,
